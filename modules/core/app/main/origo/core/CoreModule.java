...
public class CoreModule {
    ...
    public static List<AnnotationProcessor.Prototype> annotations() {
        ...
        annotations.add(new AnnotationProcessor.Prototype(Provides.class, Object.class, Node.class, String.class, Segment.class));
        annotations.add(new AnnotationProcessor.Prototype(Provides.class, Object.class, Node.class, String.class, Segment.class, Map.class));
        annotations.add(new AnnotationProcessor.Prototype(Provides.class, Object.class, Node.class, String.class, Segment.class));
        annotations.add(new AnnotationProcessor.Prototype(Provides.class, Object.class, Node.class, String.class, Segment.class, Map.class));
